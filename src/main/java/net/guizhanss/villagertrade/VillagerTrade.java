...
public final class VillagerTrade extends AbstractAddon {
    ...
    public void enable() {
        ...
        TradeConfiguration tradeConfiguration = new TradeConfiguration.Builder()
            .withTraderTypes(List.of(TraderType.valueOf(Villager.Profession.ARMORER)))
            .withInput1(new ItemStack(Material.COAL, 2))
            .withInput2(new ItemStack(Material.COAL, 2))
            .withOutput(new ItemStack(Material.DIAMOND))
            .build();
